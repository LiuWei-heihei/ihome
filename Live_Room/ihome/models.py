...
class User(BaseModel, db.Model):
    ...
    def to_dict(self):
        ...
        user_dict = {
            ...
            "name": self.name,
            "mobile": self.mobile,
            "avatar": constant.QINIU_IMAGE_IP + self.avatar_url if self.avatar_url else "",
...
class House(BaseModel, db.Model):
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            "img_url": constant.QINIU_IMAGE_IP + self.index_image_url if self.index_image_url else "",
            "room_count": self.room_count,
            "order_count": self.order_count,
            "address": self.address,
            "user_avatar": constant.QINIU_IMAGE_IP + self.user.avatar_url if self.user.avatar_url else "",
    ...
    def to_full_dict(self):
        ...
        for image in self.images:
            img_urls.append(constant.QINIU_IMAGE_IP + image.url)
        ...
        orders = Order.query.filter(Order.house_id == self.id, Order.status == "COMPLETE", Order.comment != None)\
            .order_by(Order.update_time.desc()).limit(constant.INDEX_NUM)
        for order in orders:
            comment = {
...
class Order(BaseModel, db.Model):
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            "img_url": constant.QINIU_IMAGE_IP + self.house.index_image_url if self.house.index_image_url else "",
